...
const definition = '230227_demonstrator_app_test_c.gh'

// setup input change events
const twist_slider = document.getElementById( 'twist' )
twist_slider.addEventListener( 'mouseup', onSliderChange, false )
twist_slider.addEventListener( 'touchend', onSliderChange, false )
...
const pv_slider = document.getElementById( 'PV_coverage' )
pv_slider.addEventListener( 'mouseup', onSliderChange, false )
pv_slider.addEventListener( 'touchend', onSliderChange, false )
